			...
			<div class="box_content">
				...
				<div class="span4 tri_box">
					...
					<div class="box_contents"> 
						...
						<div class="left_box"><a href="<?php the_permalink(); ?>"><?php the_excerpt(); ?></a>
				...
				<div class="span4 tri_box">
					...
					<div class="box_contents"> 
						...
						<?php while (have_posts()) : the_post(); ?>
						<div class="middle_box"><a href="<?php the_permalink(); ?>"><?php the_excerpt(); ?></a>
						<a href="<?php the_permalink(); ?>">Read More ›</a></div>
						<?php endwhile;?>
					</div>
				</div>
				...
				<div class="span4 tri_box">
					...
					<div class="box_contents"> 
						...
						<?php while (have_posts()) : the_post(); ?>
						<div class="right_box"><a href="<?php the_permalink(); ?>"><?php the_excerpt(); ?></a>
